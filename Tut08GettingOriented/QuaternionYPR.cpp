...
void keyboard(GLFWwindow *window, int key, int scancode, int action, int mods) {
	...
	case GLFW_KEY_ESCAPE:
		...
		return;
	case GLFW_KEY_W: OffsetOrientation(glm::vec3(1.0f, 0.0f, 0.0f), SMALL_ANGLE_INCREMENT); break;
	case GLFW_KEY_S: OffsetOrientation(glm::vec3(1.0f, 0.0f, 0.0f), -SMALL_ANGLE_INCREMENT); break;

	case GLFW_KEY_A: OffsetOrientation(glm::vec3(0.0f, 0.0f, 1.0f), SMALL_ANGLE_INCREMENT); break;
	case GLFW_KEY_D: OffsetOrientation(glm::vec3(0.0f, 0.0f, 1.0f), -SMALL_ANGLE_INCREMENT); break;

	case GLFW_KEY_Q: OffsetOrientation(glm::vec3(0.0f, 1.0f, 0.0f), SMALL_ANGLE_INCREMENT); break;
	case GLFW_KEY_E: OffsetOrientation(glm::vec3(0.0f, 1.0f, 0.0f), -SMALL_ANGLE_INCREMENT); break;
	case GLFW_KEY_SPACE:
