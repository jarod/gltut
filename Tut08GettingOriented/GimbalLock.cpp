...
void keyboard(GLFWwindow *window, int key, int scancode, int action, int mods) {
	...
	case GLFW_KEY_ESCAPE:
		...
		return;
	case GLFW_KEY_W: g_angles.fAngleX += SMALL_ANGLE_INCREMENT; break;
	case GLFW_KEY_S: g_angles.fAngleX -= SMALL_ANGLE_INCREMENT; break;

	case GLFW_KEY_A: g_angles.fAngleY += SMALL_ANGLE_INCREMENT; break;
	case GLFW_KEY_D: g_angles.fAngleY -= SMALL_ANGLE_INCREMENT; break;

	case GLFW_KEY_Q: g_angles.fAngleZ += SMALL_ANGLE_INCREMENT; break;
	case GLFW_KEY_E: g_angles.fAngleZ -= SMALL_ANGLE_INCREMENT; break;
